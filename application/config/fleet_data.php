...
$config['fleet_data'] = [
    [
        'title' => 'SALOON CAR (X)',
        'description' => 'This vehicle can accommodate up to 2 passengers with 2 suitcases and 2 hand luggage or up to 4 passengers for the trip.',
        'noOfPassengers' => '2',
        'noOfSuitcases' => '2',
        'vehicle_image' => 'SaloonCar.png'
    ],
    [
        'title' => 'ESTATE CAR (Comfort)',
        'description' => 'This vehicle can accommodate up to 3 passengers with 3 suitcases and 3 hand luggage or up to 3 passengers for the trip. ',
        'noOfPassengers' => '3',
        'noOfSuitcases' => '3',
        'vehicle_image' => 'EstateCar.png'
    ],
    [
        'title' => 'PEOPLE CARRIER (XL)',
        'description' => 'This vehicle can accommodate up to 4 passengers with 4 suitcases and 4 hand luggage or up to 6 passengers for the trip.',
        'noOfPassengers' => '4',
        'noOfSuitcases' => '4',
