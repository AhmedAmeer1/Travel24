<?php
class BusinessAccount extends CI_Controller {
    ...
    public function index() {
        $this->load->view('businessAccount');
    }
...
//----------------------------------------email sending start ----------------------------------------
            ...
            $this->email->to($to);
            $this->email->subject('Your Travel24 Business Account Form  has been received');
...
//------------------------------------------email sending end -------------------------------------------------------------
            ...
            if ($this->Contact_model->save_contact($name, $email, $message, $contactnumber)) {
                ...
                redirect(base_url('businessAccount'));
            } else {
