<?php
class AccidentClaim extends CI_Controller {
...
//----------------------------------------email sending start ----------------------------------------
            ...
            $this->email->to($to);
            $this->email->subject('Your Travel24 Accident Claim  Service Form  has been received');
...
//------------------------------------------email sending end -------------------------------------------------------------
            ...
            if ($this->Contact_model->save_contact($name, $email, $message, $contactnumber)) {
                ...
                redirect(base_url('accidentClaim'));
            } else {
