<?php
class WeddingsParties extends CI_Controller {
    ...
    public function index() {
        $this->load->view('weddingsParties');
    }
...
//----------------------------------------email sending start ----------------------------------------
            ...
            $this->email->to($to);
            $this->email->subject('Your Travel24 Weddings & Parties Form  has been received');
...
//------------------------------------------email sending end -------------------------------------------------------------
            ...
            if ($this->Contact_model->save_contact($name, $email, $message, $contactnumber)) {
                ...
                redirect(base_url('weddingsParties'));
            } else {
