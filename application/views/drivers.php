...
<head>
    ...
    <meta name="description"
        content="Join Travel24’s 24/7 UK airport & chauffeur fleet. We hire professional drivers with local knowledge—wheelchair-accessible vehicles, steady bookings." />
    ...
    <meta property="og:description"
        content="Become a driver with Travel 24 Taxi. Enjoy flexible hours, competitive pay, and the opportunity to provide top-notch airport transfer services across the UK.">
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/contactUs.css?v=1') ?>">
    <!-- Google tag (gtag.js) -->
