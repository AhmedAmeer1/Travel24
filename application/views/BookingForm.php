                ...
                <div class="book-form-box">
                    ...
                    <div class="content">
                        <div class="form-inner">
                            <form id="createCustomerForm" role="form" action="<?=base_url($redirectUrl)?>" method="post"
                                class="validate" data-parsley-validate="" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>PICKUP LOCATION</label>
                                    <div id="search_car">
                                        <input type="text" class="form-control autocompleteDoc" name="source" required
                                            id="pickPoint" placeholder="Enter a location">
                                ...
                                <button class="submit-btn" id="createCustomerSubmit" type="submit"
                                    class="submit-btn">Choose a Vehicle <i class="fa fa-angle-right"
...
<script type="text/javascript"
    src="http://maps.googleapis.com/maps/api/js?key=<?php echo $setting->google_api_key; ?>&sensor=false&libraries=places">
</script>
