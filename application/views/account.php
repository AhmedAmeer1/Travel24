        ...
        <section class="myaccount-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1>My Account</h1>
                        <ul class="nav nav-pills d-flex justify-content-between mb-5 mt-5" id="pills-tab"
                            role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-one" data-toggle="pill" href="#tab-content-one"
                                    role="tab" aria-controls="tab-content-one" aria-selected="true">Dashboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-two" data-toggle="pill" href="#tab-content-two" role="tab"
                                    aria-controls="tab-content-two" aria-selected="false">Orders</a>
                            </li>
                            <?php if($user_type == "customer"){?>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-three" data-toggle="pill" href="#tab-content-three"
                                    role="tab" aria-controls="tab-content-three" aria-selected="false">Account
                                    Details</a>
                            </li>
                            <?php } ?>

                            <li class="nav-item">
                                <a class="nav-link" id="tab-four" href="<?php echo base_url('Index')?>" role="tab"
                                    aria-selected="false">Logout</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="tab-content-one" role="tabpanel"
                                aria-labelledby="tab-one">
                                <div class="orders-content">
                                    <p>Hello <?php echo $user_details->fullname; ?></p>
                                    <p>(not <?php echo $user_details->fullname; ?>?<a
                                            href="<?php echo base_url('Index')?>">Logout</a> )</p>
                                    <br>
                            ...
                            <div class="tab-pane fade" id="tab-content-two" role="tabpanel" aria-labelledby="tab-two">
                                <div class="order-list">
                                    <table id="list_table">
                                        ...
                                        <tr>
                                            ...
                                            <td id="status-td-<?php echo $bd->booking_id;?>">
                                                <?php echo $bd->status_desc;?></td>
                                            <td>£ <?php echo $bd->amount;?></td>
                                            <td class="action-btns"><a data-status="<?php echo $bd->status;?>"
                                                    data-id="<?php echo $bd->booking_id;?>" class="delete-trip"
                                                    id="delete-<?php echo $bd->booking_id;?>">Delete</a>
                                                <a class="view_data" id="<?php echo $bd->booking_id;?>">View</a>
                                            </td>
                                        </tr>
                                ...
                                <div class="order-details" class="hide">
                                    <p>Order <span id="order_no"></span> was plased on <span id="order_date"></span> and
                                        is currently <span id="status"></span></p>
                                    <h2>Order details</h2>
                            ...
                            <div class="tab-pane fade" id="tab-content-three" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <?php $name = (explode(" ",$user_details->fullname)); ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="display_name" readonly class="form-control"
                                                        value="<?php echo $user_details->fullname?>">
                                                    <span>This will be how your name will be displayed in the account
