...
<link href="<?php echo base_url('assets/css/footer.css?v=3')?>" rel="stylesheet" />

<footer class="limits-footer-wrapper">
    <div class="footer-container">
        <div class="mx-auto no-gutter text-center order-md-1 order-0">
        <a  href="<?php echo base_url()?>" > <img src="<?php echo base_url('assets/images/travel24/Logo.svg')?>" class="img-fluid footr-logo" alt="Logo"></a>
