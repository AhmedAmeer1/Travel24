...
<head>
    ...
    <title>Book Your Van and Man</title>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/bookYourVanAndMan.css?v=8') ?>">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class=" ">
                        ...
                        <form action="<?= base_url('bookYourVanAndMan/send_email'); ?>" method="post">
                            <?php
