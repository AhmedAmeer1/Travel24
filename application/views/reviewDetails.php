    ...
    <section class="review-detailes-wrapper">
        <div class="container">
            <div class="details-content">
                ...
                <div class="head">
                    <button><a style="text-decoration: none;color: #FF6500;" href="<?php echo base_url()?>">Book a
                            journey</a></button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="rating-box">
                                    ...
                                    <a style="color: #000;"
                                        href="<?php echo base_url('Reviews/reviewDetails/'.encode_param($rvw['id']))?>"
                                        class="user"><b><?php echo $rvw['first_name'];?>
                                            <?php echo $rvw['last_name'];?></b></a>
