            ...
            <div class="col-xs-12">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <div class="col-md-6">
                            <h3 class="box-title">Pay Type List</h3>
                        </div>
                    </div>
                    <div class="box-body">
                ...
                if(!empty($pay_type)){
                  foreach($pay_type as $pay) {  ?>
                                <tr>
                                    ...
                                    <th class="center"><input type="radio" class="pay-status" id=<?= $pay->id ?>
                                            name=<?= $pay->id ?> value="1" <?= ($pay->status == 1)?'checked':'' ?>>
                                        <label for="male">Active</label>
                                        <input type="radio" class="pay-status" id=<?= $pay->id ?> name=<?= $pay->id ?>
                                            value="0" <?= ($pay->status == 0)?'checked':'' ?>>
                                        <label for="female">Deactive</label>
                                    </th>
                                </tr>
                                <?php } } ?>
                            </tbody>
